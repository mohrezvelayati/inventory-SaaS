...
from catalog.api.views import CategoryListCreateView, ProductDetailView, ProductListCreateView, ProductVariantCreateView, CategoryDetailView, ProductVariantDetailView, ProductVariantListView
